...
func build_character_db():
	...
	db["Goblin"]=GameCharacter.new("Goblin",{Stat.STR:3,Stat.DEX:6,Stat.CON:2,Stat.INT:1,Stat.BELT_CAP:1},"Club","Jerkin", {Attitude.NEUTRAL:["The goblin stands ready.","The goblin shouts \"I'll eat your face!\"","It brandishes it's weapon menacingly.","The goblin is sizing you up."]\
